...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            bigboxes = flipkart_html.findAll('div', {'class': '_1AtVbE col-12-12'})  # searching for appropriate tag to redirect to product link
            del bigboxes[0:3]  # the first 3 members of the list does not contain relevent information, hence deleted.
